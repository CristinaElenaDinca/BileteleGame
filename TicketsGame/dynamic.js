$("#teaserBtn").click(function(){
	...
	$("body").addClass( "begin");
	$("#addingWords").removeClass("invisible");
	var t = 20;
	var value;
	var listOfPlayers =[];
	...
	//display the teams
	$("#teams2").html("<p> The members of "+ firstTeam.name + " team are:<ul>"+ text + "</ul>" + "<p> Good luck, team!!!!</p>" + "<p> The members of "+ secondTeam.name + " team are:<ul>"+ text2 + "</ul>" + "<p> Good luck, team!!!!</p>");
	...
	//	$("#teams").css("display", "block");
		$("#playerSection").css("display", "none");
		$("#result").css("display", "block");
		$("body").removeClass( "begin" ).addClass( "end" );
